...
public class PortCallTimestampRecord extends UpdatableRecordImpl<PortCallTimestampRecord> implements Record14<Integer, Integer, Integer, Integer, Integer, PortCallTimestampType, OffsetDateTime, OffsetDateTime, Direction, Integer, String, String, Integer, Boolean> {

    private static final long serialVersionUID = -1386226399;
    ...
    @Override
    public Row14<Integer, Integer, Integer, Integer, Integer, PortCallTimestampType, OffsetDateTime, OffsetDateTime, Direction, Integer, String, String, Integer, Boolean> valuesRow() {
    ...
    @Override
    public PortCallTimestampRecord value13(Integer value) {
        setDelayCode(value);
        return this;
    }

    @Override
    public PortCallTimestampRecord value14(Boolean value) {
        setDeleted(value);
        return this;
    }

    @Override
    public PortCallTimestampRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5, PortCallTimestampType value6, OffsetDateTime value7, OffsetDateTime value8, Direction value9, Integer value10, String value11, String value12, Integer value13, Boolean value14) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
