...
export class TransportEventToTimestampTypePipe implements PipeTransform {
  ...
  transform(transportEvent: TransportEvent): PortcallTimestampType {
    ...
    } else if (transportEvent.eventTypeCode == "ARRI" && transportEvent.eventClassifierCode == "PLN" && transportEvent.locationType == "BERTH") {
    ...
    } else if (transportEvent.eventTypeCode == "DEPT" && transportEvent.eventClassifierCode == "PLN" && transportEvent.locationType == "BERTH") {
      return PortcallTimestampType.PTD_Berth
    } else if (transportEvent.eventTypeCode == "DEPT" && transportEvent.eventClassifierCode == "REQ" && transportEvent.locationType == "BERTH") {
    ...
    } else if (transportEvent.eventTypeCode == "ARRI" && transportEvent.eventClassifierCode == "PLN" && transportEvent.locationType == "PBP") {
    ...
    } else if (transportEvent.eventTypeCode == "COPS" && transportEvent.eventClassifierCode == "PLN" && transportEvent.locationType == "CARGO_OPS") {
